...
use App\Models\articles\Article_companies;
    ...
    public function index(Request $request)
    {
        ...
        $data = [
            ...
            'categoryList' => DB::table('article_category')
                ...
                ->get(),
            'companyList' => DB::table('article_companies')
                ->select('companies.*', 'article_companies.article_id')
                ->join('companies', 'article_companies.company_id', '=', 'companies.id')
                ->get(),
    ...
    public function proccessUpdate(Request $request)
    {
        ...
        if ($button != null && $button == 'update') {
            ...
            try {
                ...
                $companies = $request->get('companies');
                Article_companies::where('article_id', $id)->delete();
                if ($companies != null) {
                    foreach ($companies as $company) {
