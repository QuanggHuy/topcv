...
class AccountsController extends Controller
{
    ...
    public function profile(Request $request)
    {
        ...
        //Like_Jobss::where('user_id', session()->get('user')->id)->get();
        ...
        $companiesCommentList = DB::table('comments')
            ...
            ->get();
        $jobsCommentList = DB::table('comments')
            ->select('comments.*', 'user.fullname', 'user.photo')
            ->join('user', 'user.id', '=', 'comments.user_id')
            ->where('user.id',$id)
            ->whereNotNull('job_id')
        ...
        $jobsList= Jobs::where('deactivated',0)->get();
        ...
        $data = [
            ...
            'accountsCheckList' => Accounts::get(),
            'companiesCommentList' =>$companiesCommentList,
            'jobsCommentList' => $jobsCommentList,
