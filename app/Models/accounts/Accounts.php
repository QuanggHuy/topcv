...
class Accounts extends Authenticatable
{
    ...
    {
        return $this->hasMany(Rate_Jobs::class, 'user_id', 'id');
    }

    public function rate_mountains(): HasMany
    {
        return $this->hasMany(Rate_Companies::class, 'user_id', 'id');
    }
    public function like_mountains(): HasMany
    {
        return $this->hasMany(Like_Companies::class, 'user_id', 'id');
    }
    public function like_groups(): HasMany
    {
        return $this->hasMany(Like_Jobs::class, 'user_id', 'id');
    }
