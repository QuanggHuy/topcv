                ...
                <div class="p-5 bg-light rounded contact-form animated-border">
                    <div class="row g-4">
                        <div class="col-12 text-center">
                            <small
                                class="d-inline-block fw-bold text-dark text-uppercase bg-light border border-primary rounded-pill px-4 py-1 mb-3 ">Đăng ký</small>
                            <h1 class="display-5 mb-0 text-center">Hãy tham gia cùng chúng tôi</h1>
                        </div>
                        <div><!-- class="col-md-6 col-lg-7" -->
                            <p class="mb-4 text-center">Miễn phí và chỉ tốn vài phút</p>
                            <form method="post" class="addForm" action="{{ url('/proccessRegister') }}" enctype="multipart/form-data">
                                ...
                                <div class="mb-4">
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label class="form-check-label border-primary bg-light w-100"
                                            for="inlineRadio1">Nam</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="gender" id="inlineRadio2"
                                            value="female">
                                        <label class="form-check-label border-primary bg-light w-100"
                                            for="inlineRadio2">Nữ</label>
                                    </div>
                                </div>
                                ...
                                <input type="text" id="phone" name="phone"
                                    class="w-100 form-control p-1 mb-4 border-primary bg-light" placeholder="Số điện thoại">
                                            ...
                                            <div class="modal-dialog modal-xl">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Cắt ảnh đại diện theo tỉ lệ
                                                        </h5>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="button" class="btn btn-primary crop_image">Lưu thay đổi</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <button
                                    ...
                                    name="button" value="add" type="submit">Nộp ngay</button>
