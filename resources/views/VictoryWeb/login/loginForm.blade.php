...
<body>
    <div class="bg-image overflow-hidden" style="height: 100vh !important">
        ...
        <div class="login-container d-flex flex-column justify-content-center align-items-center h-100">
            <h1 class="display-2 text-primary fw-bold m-4">Top<span class="text-dark">CV</span> </h1>
            <div class="login-card">
                <h3 class="display-8 mb-4 text-center">Đăng nhập</h3>
                <form action="{{ url('/proccessLogin') }}" method="POST" class="signin-form">
                    ...
                    <div class="form-group text-center">
                        <button type="submit"
                            class="btn-custom btn btn-primary py-2 px-4  d-xl-inline-block rounded-pill w-100 sign-in-button">Đăng nhập</button>
                    </div>
                    <p class="form-group text-center pt-2">Hay</p>
                    <div class="form-group text-center">
                        <a href="{{ url('/register') }}"
                            class="btn-custom btn btn-primary py-2 px-4  d-xl-inline-block rounded-pill w-100">Đăng ký ngay</a>
                    </div>
                    <div class="form-group text-end">
                        <a href="" class="text-right w-100" style="width:100% !important" data-bs-toggle="modal"
                            data-bs-target="#forgetPassword">Quên mật khẩu?</a>
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <h3 class="display-8 mb-4 text-center text-hover">Chúng tôi sẽ gửi đường link thay đổi mật khẩu vào email của bạn
                    </h3>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit"
                    class="btn-custom btn btn-primary    request-button">Yêu cầu</button>
                </div>
            </form>
            </div>
        </div>
