    ...
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__wobble img-circle elevation-3" style="opacity: .8"
                src="https://play-lh.googleusercontent.com/SsaNLtRaJR44BSM1tX1jOax7rvfG4UgxqonLxui7nXQBh1Osa4EsZMUHZVXKZINo4A" alt="AdminLTELogo" height="150"
                width="150">
        </div>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ url('/admin/dashboard') }}" class="brand-link">
                <img src="https://play-lh.googleusercontent.com/SsaNLtRaJR44BSM1tX1jOax7rvfG4UgxqonLxui7nXQBh1Osa4EsZMUHZVXKZINo4A" alt="AdminLTE Logo"
                    class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light">TopCV</span>
            </a>
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ url('/admin/companies/table') }}" class="nav-link mountain_data">
                                        <i class="nav-icon far fa-solid fa-database"></i>
                                        <p>Data table</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('/admin/companies/add') }}" class="nav-link mountain_add">
                                        <i class="nav-icon far fa-solid fa-square-plus"></i>
                                        <p>Add new company</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ url('/admin/jobs/table') }}" class="nav-link group_data">
                                        <i class="nav-icon far fa-solid fa-database"></i>
                                        <p>Data table</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('/admin/jobs/add') }}" class="nav-link group_add">
                                        <i class="nav-icon far fa-solid fa-square-plus"></i>
                                        <p>Add new job</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item ">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ url('admin/rating/rateCompanies') }}" class="nav-link">
                                ...
                                <li class="nav-item">
                                    <a href="{{ url('admin/rating/rateJobs') }}" class="nav-link">
                                        <i class="nav-icon far fa-regular fa-star"></i>
                                        <p>Jobs</p>
                                    </a>
                                </li>
