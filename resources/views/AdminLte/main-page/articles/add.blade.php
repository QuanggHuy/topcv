        ...
        $(document).ready(function() {
            ...
            $('.addForm').submit(function(event) {
                ...
                if (description === '') {
                    ...
                    $('#description').addClass('border border-2 border-danger')
                    $('.note-toolbar').addClass('border border-2 border-danger')
                    $('.note-editable ').addClass('border border-2 border-danger')
                } else {
                    $('#description').removeClass('border border-2 border-danger')
                    $('.note-toolbar').removeClass('border border-2 border-danger')
                    $('.note-editable ').removeClass('border border-2 border-danger')
                }
                if (category.length == 0) {
                    console.log('category empty')
                    $('#category').addClass('border border-2 border-danger')
                } else {
                    $('#category').removeClass('border border-2 border-danger')
                }
                ...
                <div class="row">
                    <div class="col">
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form class="addForm" action="{{ url('/admin/articles/proccessAdd') }}" method="POST"
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        {{-- <input name='company_name' type="text" class="form-control" id="name" placeholder="Enter name"> --}}
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group mb-5">
                                        ...
                                        <select id="category" class="duallistbox" multiple="multiple" name="categories[]">
                                    ...
                                    <div class="form-group mb-5">
                                        ...
                                        <select class="duallistbox" multiple="multiple" name="companies[]">
                                    ...
                                    <div class="form-group">
                                        <label for="dangers">Article's status</label>
            ...
            $('.summernote1').summernote({
                ...
                callbacks: {
                    onChange: function(contents, $editable) {
                        $('#summernote-text').val(contents.replace(/(<([^>]+)>)/gi, "").trim());
                    }
                }
