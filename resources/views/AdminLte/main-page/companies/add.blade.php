            ...
            $('.addForm').submit(function(event) {
                ...
                companiesList.forEach(element => {
                    if (element.name.toLowerCase() === name.toLowerCase()) {
                        event.preventDefault();
                        error_note += 'Company name "' + name.toLowerCase() + '" is already exist ! <br>'
                        Swal.fire({
                            icon: "error",
                            title: 'Add failed !',
                            html: error_note
                ...
                <div class="row">
                    <div class="col">
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form class="addForm" action="{{ url('/admin/companies/proccessAdd') }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="name">Company name</label>
                                        <input name='company_name' type="text" class="form-control" id="name"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name='employee' type="number" class="form-control" id="employee"
                                            placeholder="Enter employee">
                                    </div>
                                    <div class="form-group">
                                        <label for="follower">Follower</label>
                                        <input name='follower' type="number" class="form-control" id="follower"
                                    ...
                                    <div class="form-group mb-5">
                                        ...
                                        <div class="input-group">
                                            <input class="form-control" type="file" id="background-photo" name="background-photo"
                                                accept="image/*">
                                        </div>
                                    </div>
                                    <div class="form-group mb-5">
                                    ...
                                    <div class="form-group">
                                        <label for="dangers">Company status</label>
