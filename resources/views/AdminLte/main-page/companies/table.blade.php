...
@section('head')
    ...
    <script>
        $(document).ready(function() {
            ...
            //         dataType: 'json',
            //         contentType: 'application/json',
            //         url: "{{ url('/admin/companies/getCurrentInfo') }}",
            //         data: {
            //             id: companyId
            //         },
            //         success: function(data) {
            ...
            //           <label for="location">Companies is location</label>
            ...
            //           <label for="history">Companies is history</label>
            ...
            //           <label for="description">Companies is description</label>
            ...
            //           <input name='company_name' type="text" class="form-control" id="name" placeholder="Enter name" value="${data.company['name']}">
            //       </div>`);
            //             setTimeout(function() {
            //                 $(target).find('#api').val(data.company['api']);
            ...
            //     var companiesList = {!! json_encode($companiesList) !!};
            ...
            //             .toLowerCase()) {
            //             event.preventDefault();
            //             error_note += 'Company name "' + name.toLowerCase() +
            //                 '" is already exist ! <br>'
            //             Swal.fire({
            //                 icon: "error",
            //                 title: 'Add failed !',
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Companies Infomation Managerment</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ url('/admin/dashboard') }}">Home</a></li>
                            <li class="breadcrumb-item active">Companies Manager</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @foreach ($countryList as $country)
                                            @if ($country->company_id == $company->id)
                                                <a>
                                                    {{ $country->name }}
                                                </a>
                                                <br>
                                    ...
                                    <td class="project-actions text-left">
                                        <a class="btn btn-primary btn-sm "
                                            href="{{ url('/admin/companies/detail?id=' . $company->id) }}">
                                        ...
                                        <div class="modal fade" id="update{{ $company->id }}">
                                            <div class="modal-dialog modal-xl">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">Update form for company id:
                                                            "{{ $company->id }}"</h4>
                                                    ...
                                                    <form class="updateForm"
                                                        action="{{ url('/admin/companies/proccessUpdate') }}"
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="card-body fill-update-input-box">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input name='follower' type="text"
                                                                        class="form-control" id="follower"
                                                                        placeholder="Enter follower"
                                                                        value="{{ $company->follower }}">
                                                                </div>
                                                                ...
                                                                <div class="form-group mb-5">
                                                                    ...
                                                                    <select class="duallistbox" multiple="multiple"
                                                                        ...
                                                                        @foreach ($countriesList as $country)
                                                                            ...
                                                                            @if ($option->id == $country->id && $option->company_id == $company->id) 
                                                                ...
                                                                <div class="form-group mb-5">
                                                                    <label for="background-photo">Background photo</label>
                                                                    <br>
                                                                    <img class="rounded mx-auto d-block mb-2 img-fluid w-50"
                                                                    ...
                                                                    <div class="input-group">
                                                                        <input class="form-control  p-0 h-100"
                                                                            type="file" id="background-photo"
                                                                            name="background-photo" accept="image/*">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group mb-5">
                                                                        ...
                                                                        <div class="card-body">
                                                                            <div class="row">
                                                                                @foreach ($photoList as $photo)
                                                                                    @if ($photo->company_id == $company->id && $photo->name != $company->photo_main)
                                                                                        <div class="col-sm-2">
                                                                                            <a id="firstlink"
                                                                                                class="venobox"
                                                                                                data-gall="mygallery"
                                                                                                data-title="Luke jones @lukejonesdesign"
                                                                                                href="{{ asset('/img/companies/' . $company->id . '/' . $photo->name) }}"><img
                                                                                                    class="img-fluid mb-2"
                                                                                                    src="{{ asset('/img/companies/' . $company->id . '/' . $photo->name) }}"></a>
                                                                    ...
                                                                    <div class="card card-primary">
                                                                        ...
                                                                        <div class="card-body">
                                                                            ...
                                                                            @foreach ($videoList as $video)
                                                                                @if ($video->company_id == $company->id)
                                                                                    <div>
                                                                                        <a class="venobox"
                                                                                            data-autoplay="true"
                                                                                            data-vbtype="video"
                                                                                            data-ratio="1x1"
                                                                                            data-maxwidth="400px"
                                                                                            href="{{ asset('/img/companies/' . $company->id . '/' . $video->name) }}">
                                                                                            <button type="button"
                                        ...
                                        @if ($company->deactivated == 0)
                                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                                data-target="#deactivate{{ $company->id }}">
                                        ...
                                        @else
                                            <button type="button" class="btn btn-success btn-sm" data-toggle="modal"
                                                data-target="#activate{{ $company->id }}">
                                                <i class="fa-solid fa-circle-right"></i>
                                                activate
                                            </button>
                                        @endif
                                        <!-- Remove modal -->
                                        <form action="{{ url('/admin/companies/activate') }}" method="POST">
                                            @csrf
                                            <input type="hidden" name="id" value="{{ $company->id }}">

                                            <div class="modal fade" id="deactivate{{ $company->id }}">
                                                <div class="modal-dialog modal-md">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body text-left">
                                                            <p>This action will not remove the company from server</p>
                                                        </div>
                                                        <div class="modal-footer justify-content-between">
                                                            <button type="button" class="btn btn-default"
                                                                data-dismiss="modal">Close</button>
                                            ...
                                            <div class="modal fade" id="activate{{ $company->id }}">
                                                <div class="modal-dialog modal-md">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                        ...
                                                        <div class="modal-body text-left">
                                                            <p>This action will reactivate the company from server</p>
                                                        </div>
                                                        <div class="modal-footer justify-content-between">
                                                            <button type="button" class="btn btn-default"
                                                                data-dismiss="modal">Close</button>
