                ...
                <div class="timeline timeline-inverse">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Average Rating jobs</h3>
                                    ...
                                    <li class="item">
                                        ...
                                        <div class="product-info text-start">
                                            ...
                                            <a href="{{ url('/admin/jobs/detail?id=' . $job->id) }}"
                                                class="product-title truncate-text float-left">{{ $job->name }}</a>
                                            <br>
                                            <span class="badge ">
