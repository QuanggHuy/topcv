...
@section('head')
    ...
    <title>VicTory Companies - Admin</title>
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Rate-Comapnies</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                ...
                <div class="timeline timeline-inverse">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Average Rating Companies</h3>
                            ...
                            <ul class="products-list product-list-in-card pl-2 pr-2">
                                @foreach ($companiesList as $company)
                                    <li class="item" style="height: 100px">
                                        <div class="product-img" style="height: 100%; width:auto">
                                            {{-- <img src="{{ asset('/') }}AdminLte/dist/img/default-150x150.png"
                                                alt="Product Image" class="img-size-50"> --}}

                                            <img src="{{ asset('/img/comapnies/' . $company->id . '/' . $company->photo_main) }}"
                                        ...
                                        <div class="product-info text-start">
                                            ...
                                            <a href="{{ url('/admin/companies/detail?id=' . $company->id) }}"
                                                class="product-title truncate-text float-left">{{ $company->name }}</a>
                                            <br>
                                            <span class="badge ">
