    ...
    <script>
        $(document).ready(function() {
            ...
            $('.addForm').submit(function(event) {
                ...
                if (name === '' || title === '' || salary === '' || experience === '' || description === '' || contact === '') {
                    event.preventDefault();
                    Swal.fire({
                        icon: "error",
                        title: "Oops...",
                ...
                <div class="row">
                    <div class="col">
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form class="addForm" action="{{ url('/admin/jobs/proccessAdd') }}" method="POST"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="dangers">Job status</label>
