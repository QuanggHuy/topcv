                    ...
                    <div class="col-12 col-sm-6 col-md-3">
                        <div class="info-box mb-3">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ $jobs }}
                                    <small>total</small>
                                </span>
                            </div>
                            <!-- /.info-box-content -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <div class="text-center mx-auto">
                                    <a href="{{ url('/admin/companies/table') }}" class="link">View All Companies</a>
                                </div>
                                ...
                                <div class="d-md-flex">
                                    ...
                                    <div class="card-pane-right bg-dark pt-2 pb-2 pl-4 pr-4">
                                        ...
                                        <div class="description-block mb-4">
                                            ...
                                            <h5 class="description-header">{{ $likes_companies }}</h5>
                                        ...
                                        <div class="description-block mb-4">
                                            ...
                                            <span class="description-text">out of {{ $rates_companies }}</span>
                                        </div>
                                        <!-- /.description-block -->
                                        <div class="description-block">
                                            <div class="sparkbar pad" data-color="#fff">Activate</div>
                                            <h5 class="description-header">{{ $companies0 }}</h5>
                                            <span class="description-text">Out of {{ $companies }}</span>
                                        </div>
                                        <!-- /.description-block -->
                                    </div><!-- /.card-pane-right -->
                                </div><!-- /.d-md-flex -->
                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <div class="d-flex align-items-center">
                                    <h3 class="card-title m-0">Jobs</h3>
                                </div>
                                <div class="text-center mx-auto">
                                    <a href="{{ url('admin/jobs/table') }}" class="link">View All Jobs</a>
                                </div>
                                <div class="card-tools d-flex align-items-center">
                                    <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                        <i class="fas fa-minus"></i>
                            ...
                            <div class="card-body p-0">
                                <div class="d-md-flex">
                                    ...
                                    <div class="card-pane-right bg-dark pt-2 pb-2 pl-4 pr-4">
                                        ...
                                        <div class="description-block mb-4">
                                            <div class="sparkbar pad" data-color="#fff">Total</div>
                                            <h5 class="description-header">{{ $likes_jobs }}</h5>
                                            <span class="description-text">Likes</span>
                                        </div>
                                        <!-- /.description-block -->
                                        <div class="description-block mb-4">
                                            ...
                                            <span class="description-text">out of {{ $rates_jobs }}</span>
                                        </div>
                                        <!-- /.description-block -->
                                        <div class="description-block">
                                            <div class="sparkbar pad" data-color="#fff">Activate</div>
                                            <h5 class="description-header">{{ $jobs0 }}</h5>
                                            <span class="description-text">Out of {{ $jobs }}</span>
                                        </div>
                                        <!-- /.description-block -->
                                    </div><!-- /.card-pane-right -->
                                </div><!-- /.d-md-flex -->
