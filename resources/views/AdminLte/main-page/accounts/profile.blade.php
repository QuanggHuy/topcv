                                                ...
                                                <div>
                                                    ...
                                                    <div class="timeline-item ">
                                                        ...
                                                        <span
                                                            ...
                                                            <span>
                                                                <a href="{{ url('/admin/companies/detail?id=' . $company->id) }}"
                                                        ...
                                                        <h3 class="timeline-header "><a
                                                                href="{{ url('/admin/companies/detail?id=' . $company->id) }}">{{ $company->name }}</a>
                                                            [id:{{ $company->id }}]</h3>
                                                    </div>
                                                </div>
                                            @endforeach
                                                ...
                                                <div>
                                                    ...
                                                    <div class="timeline-item ">
                                                        ...
                                                        <span
                                                            ...
                                                            <span>
                                                                <a href="{{ url('/admin/jobs/detail?id=' . $job->id) }}"
                                                                    class="btn btn-info btn-sm"><i
                                                                        class="fa-solid fa-circle-info"></i></a>
                                                            </span>
                                                        ...
                                                        <h3 class="timeline-header "><a
                                                                href="{{ url('/admin/jobs/detail?id=' . $job->id) }}">{{ $job->name }}</a>
                                                            [id:{{ $job->id }}]</h3>
                                                    </div>
                                                </div>
                                            @endforeach
                                    ...
                                    <div class="tab-pane" id="comment">
                                        <div class="timeline timeline-inverse">
                                            ...
                                            @foreach ($companiesList as $company)
                                                @if ($companiesCommentList->contains('company_id', $company->id))
                                                    <div>
                                                        <i class="fas bg-danger fa-solid  fa-mountain "></i>
                                                        <div class="timeline-item ">
                                                            ...
                                                            <div class="timeline-body card-comments">
                                                                @foreach ($companiesCommentList as $companyComment)
                                                                    @if ($companyComment->company_id == $company->id)
                                                                        <div class="card-comment"
                                                                            id="mountainComment{{ $companyComment->id }}">
                                                                            <!-- User image -->
                                                                            ...
                                                                            <div class="comment-text">
                                                                                <span class="username">
                                                                                    {{ $account->fullname }}
                                                                                    <span
                                                                                        class="text-muted float-right">{{ \Carbon\Carbon::parse($companyComment->created)->format('H:i d/m/Y') }}</span>
                                                                                </span><!-- /.username -->
                                                                            ...
                                                                            <span class="d-flex justify-content-between"
                                                                                ...
                                                                                <span class="ml-4">
                                                                                    -{{ $companyComment->comment_text }}
                                                                                </span>

                                                                                <button id="{{ $companyComment->id }}"
                                                                                    value="companyComment{{ $companyComment->id }}"
                                            ...
                                            @foreach ($jobsList as $job)
                                                @if ($jobsCommentList->contains('job_id', $job->id))
                                                    <div>
                                                        <i class="fas bg-purple fa-solid fa-people-group"></i>
                                                        <div class="timeline-item ">
                                                            ...
                                                            <div class="timeline-body card-comments">
                                                                @foreach ($jobsCommentList as $jobComment)
                                                                    @if ($jobComment->job_id == $job->id)
                                                                        <div class="card-comment"
                                                                            id="groupComment{{ $jobComment->id }}">
                                                                            <!-- User image -->
                                                                            ...
                                                                            <div class="comment-text">
                                                                                <span class="username">
                                                                                    {{ $account->fullname }}
                                                                                    <span
                                                                                        class="text-muted float-right">{{ \Carbon\Carbon::parse($jobComment->created)->format('H:i d/m/Y') }}</span>
                                                                                </span><!-- /.username -->
                                                                            ...
                                                                            <span class="d-flex justify-content-between"
                                                                                style="width:100% !important">
                                                                                <span class="ml-4">
                                                                                    -{{ $jobComment->comment_text }}
                                                                                </span>

                                                                                <button id="{{ $jobComment->id }}"
                                                                                    value="jobComment{{ $jobComment->id }}"
                                                                                    class="comment_delete btn btn-danger btn-sm"><i
                                                                                        class="fa-solid fa-trash-can"></i></button>
                                                                            </span>
                                                                        </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="timeline-item ">
                                                            ...
                                                            <h3 class="timeline-header "><a
                                                                ...
                                                                <i class="fa-solid fa-arrow-right"></i>
                                                                <a
                                                                    href="{{ url('/admin/articles/detail?id=' . $article->id) }}">{{ $company->name }}</a>
                                                            </h3>
